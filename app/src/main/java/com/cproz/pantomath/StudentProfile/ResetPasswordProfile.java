...
import com.cproz.pantomath.Login.ForgetPopup;
...
public class ResetPasswordProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reset_password_profile);
                ...
                if (resetEmail.getText().toString().isEmpty()){
                    ...
                    firebaseAuth.sendPasswordResetEmail(resetEmail.getText().toString()).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(ResetPasswordProfile.this, "Please enter your Registered email", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
